...
public:
  ...
  bool mouseMoved( const OIS::MouseEvent &evt )
  {
    // Fill Here -----------------------------------------------------
	  ...
	  mCameraHolder->translate(Vector3(0, 0, -evt.state.Z.rel * 0.1f));
...
public:
  ...
  void go(void)
  {
    ...
    // Fill Here ----------------------------------------------------------------------------------------------
	SceneNode* cameraYaw =
		professorRoot->createChildSceneNode("CameraYaw", Vector3(0.f, 120.f, 0.f));

	SceneNode* cameraPitch =
		cameraYaw->createChildSceneNode("CameraPitch");

	SceneNode* cameraHolder =
		cameraPitch->createChildSceneNode("CameraHolder", Vector3(0.f, 80.f, 500.f));
